...
func applyAction(referencePoint coordinate, action string) (path []coordinate, lastCoordinate coordinate) {
	...
	// fmt.Printf("Action: %s, Direction %c, Movement: %d\n", action, direction, movement)
...
func getClosestCommonCoordinate(referencePoint coordinate, coordinates []coordinate) (closestCommonCoordinateDistance int) {
	...
	for _, c := range coordinates {
		xCalc := absValue(c.x - c.y)
		yCalc := absValue(referencePoint.x - referencePoint.y)
...
func main() {
	...
	// firstWirePath := []string{"R5", "U5", "L5", "D1"}
	// secondWirePath := []string{"D5", "L5", "D1"}

	centralPort := coordinate{x: 5000, y: 5000}
	...
	fmt.Println(firstWireFullCoordinatesPath)
	fmt.Println("****** END FIRST PATH **********")
	fmt.Println("****** SECOND PATH **********")
	fmt.Println(secondWireFullCoordinatesPath)
	fmt.Println("****** END SECOND PATH **********")
